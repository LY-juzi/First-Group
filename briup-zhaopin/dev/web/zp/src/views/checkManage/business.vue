 ...
 * @Last Modified time: 2019-12-28 19:12:10
 */
<template>
  
  <div id="businessCheck">{{businessData}}
    <div class="searchDiv">
    ...
    <div class="tableDiv">
      ...
      >
        ...
        <!-- <el-table-column align="center" label="操作" width="100">
           ...
           <template slot-scope="scope">
             <el-button type="text" size="small" @click="toDelete(scope.row.id)">通过</el-button>
            <el-button type="text"  @click="toEdit(scope.row)" size="small">拒绝</el-button> 
          </template>
        </el-table-column> -->
    ...
    <!-- 修改模态框 -->
    <!-- <el-dialog title="确定通过审核吗" :visible.sync="editVisible" width="10%">
       <el-row :gutter="20">
          <el-col :span="60">
            <el-form-item prop="location" label="拒绝的理由" :label-width="formLabelWidth">
