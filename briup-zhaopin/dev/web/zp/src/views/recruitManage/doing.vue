  ...
  <div id="recruitDoing">
    ...
    <template>
      ...
      >
        ...
        <el-table-column align="center" prop="publishTime" :formatter="formatDate" label="发布时间"></el-table-column>
        ...
        <el-table-column align="center" label="操作" width="120">
          <template slot-scope="scope">
            <el-button @click.native.prevent="toShow(scope.row)" type="text" size="small">修改</el-button>
            <el-button @click.native.prevent="toDelete(scope.row.id)" type="text" size="small">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </template>
